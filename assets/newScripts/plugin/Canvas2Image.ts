...
export class Canvas2Image {
    public static getInstance() {
        ...
        function saveFile(strData: any, type: any, fileName: any) {
         ...
         */
        var saveAsImage = function (canvas: any, width: any, height: any, type: any, fileName: any) {
            /**
        ...
        var convertToImage = function (canvas: any, width: any, height: any, type: any) {
            if ($support.canvas && $support.dataURL) {
                if (typeof canvas == "string") { canvas = document.getElementById(canvas); }
                if (type == undefined) { type = 'png'; }
                type = fixType(type);
        ...
        var fileDownload = function (downloadUrl: any, type: any, fileName: any) {
        ...
        return {
            ...
            saveAsGIF: function (canvas: any, width: any, height: any) {
                return saveAsImage(canvas, width, height, 'gif', 'defaultgif');
            },
            saveAsBMP: function (canvas: any, width: any, height: any) {
